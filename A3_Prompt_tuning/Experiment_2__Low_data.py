...
prompt_size = 8
batch_size = 2
save_path = f"../Saved_weights/EXP2/Prompt_Tuning/{MODEL_NAME}"
######################################################
...
for train_size in dataset_sizes:
    ...
    torch.save(soft_prompts, f"{save_path}/prompt_size__{prompt_size}____data_{train_size}.pth")
    ...
    with open(f"{save_path}/logs_prompt_size__{prompt_size}__data_{train_size}.json", "w") as f:
        json.dump({
